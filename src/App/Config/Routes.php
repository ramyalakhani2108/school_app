...
function register_routes(App $app)
{
    ...
    $app->get("/admin/subjects/remove_std_sub/{std_id}", [SubjectsController::class, 'remove_std_sub'])->add(AuthTokenMiddleware::class);
    $app->get("/admin/subjects/remove_std_sub/", [SubjectsController::class, 'remove_std_sub'])->add(AuthTokenMiddleware::class);
    $app->get("/admin/subjects/add_std_sub/{std_id}", [SubjectsController::class, 'add_std_sub'])->add(AuthTokenMiddleware::class);
    $app->post("/admin/subjects/add_std_sub/", [SubjectsController::class, 'add_std_sub'])->add(AuthTokenMiddleware::class);
    ...
    // $app->get("/admin/subjects/remove_teachers/", [SubjectsController::class, 'remove_teachers'])->add(AuthTokenMiddleware::class);
